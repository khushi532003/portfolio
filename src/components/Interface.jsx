...
const Section = (props) => {
    ...
    return <>
        <motion.section className={`w-screen h-screen max-w-screen-2xl p-16 mx-auto flex flex-col items-start justify-center`}
            initial={{
                opacity: 0,
                y: 50,
            }}
    ...
    return (
        <Section>
            <h1 className="text-6xl font-extrabold leading-snug">
                Hi, I'm
                <br />
                <span className="bg-white px-1 italic">Khushi Kashyap</span>
            </h1>
            ...
            <motion.p className="text-lg text-gray-600 mt-4"
                ...
                I create 3D websites to help developers
                <br />
                ...
                <div className="mt-8 space-y-4">
                    {skills.map((skill, index) => (
                        <div className="w-64" key={index}>
                            <motion.div className="text-xl font-bold text-gray-800"
                                initial={{
                                    opacity: 0
                                }}
                                variants={{
